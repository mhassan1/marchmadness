        ...
        <div className='container-fluid'>
          ...
          <div className='row'>
            <div className='col-md-3'>
              ...
              (Last Update: {new Date(this.state.standings.lastupdate).toLocaleString()})
              </p>
              <Standings selectedUser={this.state.selectedUser} standings={this.state.standings.standings} onSelectUser={this.onSelectUser}/>
            </div>
            <div className='col-md-9'>
              <Bracket bracket={this.state.standings.brackets[this.state.selectedUser]}/>
            </div>
          </div>
        </div>
      )
